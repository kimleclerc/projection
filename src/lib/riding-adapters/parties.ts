...
export interface PartyMeta {
  ...
  logo?: string;
  /** Square-ish EMBLEM only, no wordmark (e.g. "uk-lab-icon.png") — the mark
   *  that survives at chip size. `logo` is the full lockup and is often a
   *  wordmark (Labour is 4.3:1, the Ontario NDP 7:1), unreadable once shrunk.
   *  Absent where a party has no emblem, and deliberately absent for the
   *  French BLOCS: a bloc is a coalition, and the RN's mark on "RN et alliés"
   *  would pass one off as the other. */
  icon?: string;
...
export const CA_FEDERAL_PARTIES: Record<string, PartyMeta> = {
  lib:     { label_en: 'Liberal',      label_fr: 'Libéral',       color: '#D71920', logo: 'ca-lib.svg', icon: 'ca-lib-icon.svg', mention_fr: 'du Parti libéral',      mention_en: 'the Liberal Party',      mention_es: 'el Partido Liberal' },
  con:     { label_en: 'Conservative', label_fr: 'Conservateur',  color: '#1A4782', logo: 'ca-con.svg', icon: 'ca-con-icon.png', mention_fr: 'du Parti conservateur', mention_en: 'the Conservative Party', mention_es: 'el Partido Conservador' },
  ndp:     { label_en: 'NDP',          label_fr: 'NPD',           color: '#F37021', logo: 'ca-ndp.svg', icon: 'ca-ndp-icon.png', mention_fr: 'du NPD',                mention_en: 'the NDP',                mention_es: 'el NPD' },
...
export const ON_PARTIES: Record<string, PartyMeta> = {
  on_pc:  { label_en: 'PC',  label_fr: 'PC',  color: '#0F4C81', logo: 'on-pc.svg', icon: 'on-pc-icon.png', mention_fr: 'du PC',              mention_en: 'the PC Party',         mention_es: 'el PC' },
  on_olp: { label_en: 'OLP', label_fr: 'OLP', color: '#ED1C24', logo: 'on-lib.svg', icon: 'on-lib-icon.svg', mention_fr: 'du PLO',             mention_en: 'the Ontario Liberals', mention_es: 'los Liberales de Ontario' },
...
export const UK_PARTIES: Record<string, PartyMeta> = {
  // Britain mainland
  uk_lab: { label_en: 'Labour',       label_fr: 'Travailliste',         color: '#E4003B', logo: 'uk-lab.svg', icon: 'uk-lab-icon.png', mention_fr: 'des Travaillistes',        mention_en: 'Labour',                mention_es: 'los Laboristas' },
  ...
  ni_sdlp:  { label_en: 'SDLP',        label_fr: 'SDLP',                color: '#2AA82C', logo: 'ni-sdlp.svg', icon: 'ni-sdlp-icon.png', mention_fr: 'du SDLP',                  mention_en: 'the SDLP',              mention_es: 'el SDLP' },
  ...
  ni_uup:   { label_en: 'UUP',         label_fr: 'UUP',                 color: '#48A5EE', logo: 'ni-uup.png', icon: 'ni-uup-icon.png', mention_fr: 'de l’UUP',                 mention_en: 'the UUP',               mention_es: 'el UUP' },
