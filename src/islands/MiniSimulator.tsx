...
const COPY = {
  fr: {
    ...
    viewTiles: 'Carte proportionnelle',
    gainOn: 'gain sur',
    viewGeo: 'Carte des circonscriptions',
    total: 'Total',
  ...
  en: {
    ...
    viewTiles: 'Proportional map',
    gainOn: 'gain from',
    viewGeo: 'District map',
    total: 'Total',
  ...
  es: {
    ...
    viewTiles: 'Mapa proporcional',
    gainOn: 'gana a',
    viewGeo: 'Mapa de distritos',
    total: 'Total',
