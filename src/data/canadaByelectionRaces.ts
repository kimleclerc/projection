...
export const canadaByelectionRaces = {
  'chicoutimi-le-fjord': {
    ...
    description: {
      en: 'Richard Martel took his Senate seat — and his personal vote with him. Three local polls later, the Conservatives are below 20% and the race is a Liberal–Bloc duel. Vote-Scope measures what the former Saguenéens coach was actually worth, and what came on top of it.',
      fr: 'Richard Martel part au Sénat et emporte son vote personnel. Trois sondages locaux plus tard, le conservateur est sous 20 % et la partielle est devenue un duel libéral–bloquiste. Vote-Scope mesure ce que valait vraiment l’ancien entraîneur des Saguenéens — et ce qui s’est ajouté par-dessus.',
      es: 'Richard Martel se va al Senado y se lleva su voto personal. Tres encuestas locales después, el conservador está por debajo del 20 % y la parcial es un duelo liberal–bloquista. Vote-Scope mide cuánto valía el exentrenador de los Saguenéens y qué se sumó después.',
    },
    kicker: {
    ...
    dek: {
      en: 'Before Richard Martel, this seat gave the Conservatives exactly the Quebec average — no premium at all. He turned it into a 20-point personal fortress. Now he is a senator, and the three local polls describe a fall deeper than his personal vote alone: the Conservatives go from 26% in July to 15.4% and then 16.8% in August, while the Liberal and the Bloc pull away within three points of each other.',
      fr: 'Avant Richard Martel, ce siège donnait aux conservateurs exactement la moyenne québécoise — aucune prime. Il en a fait une forteresse personnelle de 20 points. Le voilà sénateur, et les trois sondages locaux racontent une chute plus profonde que son seul vote personnel : le conservateur passe de 26 % en juillet à 15,4 puis 16,8 % en août, pendant que le libéral et le bloquiste se détachent à moins de trois points l’un de l’autre.',
      es: 'Antes de Richard Martel, este escaño daba a los conservadores exactamente la media quebequesa — ninguna prima. Él lo convirtió en una fortaleza personal de 20 puntos. Ahora es senador, y las tres encuestas locales describen una caída más profunda que su solo voto personal: el conservador pasa del 26 % en julio al 15,4 y luego al 16,8 % en agosto, mientras el liberal y el bloquista se separan a menos de tres puntos uno de otro.',
    },
    why: {
      en: [
        ...
        'Three local polls, and a Conservative fall that keeps going: Pallas has them at 26% on July 18 — down 7.7 points from 2025, almost exactly the personal vote measured from the historical record — then Poliwave at 15.4% (August 16–19) and Segma at 16.8% the following week.',
        'Below 20%, the Quebec tactical-consolidation regime measured in Terrebonne triggers: when the Conservative is no longer viable locally, that vote does not sit still, it picks a side.',
        'Poliwave’s field closed on August 19, two days before the trade talks with Washington collapsed; Segma’s straddles the rupture. Liberal Daniel Gobeil, former president of the Quebec milk producers’ federation, carries supply management into a by-election where it has just become the issue.',
      ],
      fr: [
        ...
        'Trois sondages locaux, et une chute conservatrice qui s’accentue : Pallas les donne à 26 % le 18 juillet — 7,7 points sous leur résultat de 2025, soit presque exactement le vote personnel mesuré dans l’historique — puis Poliwave à 15,4 % (16 au 19 août) et Segma à 16,8 % la semaine suivante.',
        'Sous 20 %, le régime québécois de consolidation tactique mesuré à Terrebonne se déclenche : quand le conservateur n’est plus viable localement, ce vote ne reste pas immobile, il choisit un camp.',
        'Le terrain de Poliwave se ferme le 19 août, deux jours avant la rupture des pourparlers commerciaux avec Washington ; celui de Segma la chevauche. Le libéral Daniel Gobeil, ancien président des Producteurs de lait du Québec, porte la gestion de l’offre dans une partielle où elle vient de devenir l’enjeu.',
      ],
      es: [
        ...
        'Tres encuestas locales, y una caída conservadora que continúa: Pallas los sitúa en 26 % el 18 de julio — 7,7 puntos menos que en 2025, casi exactamente el voto personal medido en el histórico — luego Poliwave en 15,4 % (16 al 19 de agosto) y Segma en 16,8 % la semana siguiente.',
        'Por debajo del 20 %, se activa el régimen quebequés de consolidación táctica medido en Terrebonne: cuando el conservador deja de ser viable localmente, ese voto no se queda quieto, elige bando.',
        'El trabajo de campo de Poliwave cerró el 19 de agosto, dos días antes de la ruptura de las negociaciones comerciales con Washington; el de Segma la atraviesa. El liberal Daniel Gobeil, expresidente de los productores de leche de Quebec, lleva la gestión de la oferta a una parcial donde acaba de convertirse en EL tema.',
      ],
    },
    modelNote: {
      en: 'Three constituency polls, weighted very differently. Pallas (July 18) predates the campaign and the candidate announcements: it stays visible as history but no longer feeds the active anchor. Poliwave (August 16–19) carries it. Segma (n=448) confirms it at 35% weight only — no field end date, mode, weighting or questionnaire published. Martel’s personal vote is applied solely to the share the anchor does not already cover: a poll asking voters about THIS by-election carries the effect already, and reapplying it in full would double-count.',
      fr: 'Trois sondages de circonscription, de poids très inégaux. Pallas (18 juillet) précède la campagne et l’annonce des candidats : il reste affiché comme historique mais ne nourrit plus l’ancre active. Poliwave (16 au 19 août) la porte. Segma (n=448) la confirme, à 35 % de poids seulement — ni date de fin de terrain, ni mode, ni pondération, ni questionnaire publiés. Le vote personnel de Martel ne s’applique qu’à la part que l’ancre ne couvre pas déjà : un sondage qui interroge les électeurs sur CETTE partielle porte déjà l’effet, et le réappliquer en entier serait un double comptage.',
      es: 'Tres encuestas de circunscripción, con pesos muy desiguales. Pallas (18 de julio) es anterior a la campaña y al anuncio de los candidatos: sigue visible como histórico pero ya no alimenta el anclaje activo. Poliwave (16 al 19 de agosto) lo sostiene. Segma (n=448) lo confirma, con solo un 35 % de peso — sin fecha de cierre de campo, modo, ponderación ni cuestionario publicados. El voto personal de Martel se aplica únicamente a la parte que el anclaje no cubre ya: una encuesta que pregunta por ESTA parcial ya contiene el efecto, y volver a aplicarlo entero sería contarlo dos veces.',
    },
    paths: {
