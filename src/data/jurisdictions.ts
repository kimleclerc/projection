...
export const jurisdictions: Record<string, Jurisdiction> = {
  ...
  quebec: {
    ...
    metaDescription: {
      fr: 'Projection des 127 sièges de l\'Assemblée nationale du Québec — parti en tête, fragile ou solide, et ce que le marché ne voit pas encore. Mis à jour en continu.',
      en: 'Live projection of 127 Quebec National Assembly seats — top party, fragility signals, and what the market is missing. Updated continuously.',
      es: 'Proyección de los 127 escaños de la Asamblea Nacional de Quebec — partido líder, señales de fragilidad y lo que el mercado pasa por alto. Actualizado continuamente.',
    },
    baselineYear: 2022,
    seatsTotal: 127,
    byelections: false,
