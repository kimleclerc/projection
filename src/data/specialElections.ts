...
export const specialElections = {
  ...
  ca14: {
    ...
    currentPage: 'usa-hub',
    modelBadge: 'Fundamentals-only',
    title: 'CA-14 Special General Election — Vote-Scope',
    title_fr: 'Élection générale spéciale CA-14 — Vote-Scope',
    title_es: 'Elección general especial CA-14 — Vote-Scope',
