...
export const EQUITY_STRINGS = {
  fr: {
    ...
    trackLedeClosed: 'Déclarations closes : les cinq partis présentent une équipe complète.',
  ...
  en: {
    ...
    trackLedeClosed: 'Nominations closed: all five parties are running a full slate.',
  ...
  es: {
    ...
    trackLedeClosed: 'Candidaturas cerradas: los cinco partidos presentan una lista completa.',
